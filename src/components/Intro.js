        ...
        <>
            ...
            <section data-aos="zoom-in-down">
                    <div className="my-4 py-4">
                        <h2 className="my-2 text-center text-3xl text-blue-900 uppercase font-bold">Why businesses choose ArcUC</h2>
                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                ...
                                {/* <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img} /> */}
                                    ...
                                    Telecommunication Solutions							</h2>
                                    <p className="text-md font-medium">
                                    From voice communication to video conferencing, we provide a comprehensive suite of telecommunication services that ensure crystal-clear communication across distances.                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                ...
                                {/* <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img2} /> */}
                                    ...
                                    <p className="text-md font-medium">
                                    Our state-of-the-art network infrastructure is the backbone of reliable and high-speed internet services, connecting people and businesses with the world.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                <div className="m-2 text-justify text-sm">
                                    ...
                                    <p className="text-md font-medium">
                                    Security is paramount in the digital age. Our robust security solutions safeguard your data and communications, ensuring privacy and compliance with industry standards.
                                    </p>
                                </div>
                            </div>
